...
namespace Binoc.Core.Changelog;
...
/// and hands it in. Headings look like <c>## [v0.1.0] - 2026-09-23</c>; the <c>v0.1.0</c> is the version.
/// Ported from Perch's ChangelogParser so the two apps' "what's new" flows behave identically.
/// </summary>
public static class ChangelogParser
{
    ...
    /// <summary>Pulls a <see cref="System.Version"/> out of a heading like <c>[v0.1.0] - 2026-09-23</c>.</summary>
